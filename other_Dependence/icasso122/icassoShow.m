function [Iq, A, W, S, index2centrotypes,h1,h2,h3,h4,h5,h6]=icassoShow(sR,varargin)
...
set(h2,'name','Icasso: Estimate Quality');
...
switch est 
 case 'source'
  h5 = figure(5); clf reset;
  set(h5,'name','Icasso: Source Estimates (centrotypes)');
 ...
 case 'demixing'
  h5 = figure(5); clf reset;
  set(h5,'name','Icasso: Demixing Matrix Estimate');
 ...
 case 'mixing'
  h5 = figure(5); clf reset;
  set(h5,'name','Icasso: Mixing Matrix Estimate');
...
if detailedrankplot,
  h6 = figure(6); clf;
  set(h6,'name','Icasso: Detaild Estimate Stability');
